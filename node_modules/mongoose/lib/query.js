 ...
 * #### Example
 *
 *     // Create a query for adventure contacts and read from the primary
 *     // node in the replica-set unless it is down, in which case we'll
 *     // read from a secondary node.
 *     const query = Contact.find({ tags: 'adventure' }).read('primaryPreferred');
 *
 ...
 *
 *     // Using async/await
 *     const arr = await Contact.find({ year: { $gte: 1980, $lte: 1989 } });
 *
 *     // Using callbacks
 *     Contact.find({ year: { $gte: 1980, $lte: 1989 } }, function(err, arr) {});
 *
